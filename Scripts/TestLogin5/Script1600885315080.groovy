...
WebUI.click(findTestObject('Page_5/a_CURA Healthcare_menu-toggle'))

WebUI.click(findTestObject('Page_5/a_Login'))

WebUI.click(findTestObject('Page_5/button_Login'))
